...
public class ProductDTO {
	...
	private int product_purchases_count;
	...
	private String product_today;
	
	
	public String getProduct_today() {
		return product_today;
	}
	public void setProduct_today(String product_today) {
		this.product_today = product_today;
	}
	...
	public int getProduct_purchases_count() {
		return product_purchases_count;
	}
	public void setProduct_purchases_count(int product_purchases_count) {
		this.product_purchases_count = product_purchases_count;
	}
