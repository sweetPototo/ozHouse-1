...
public class Order_QADTO {
	...
	private String order_QA_subject;
	private String order_QA_content;
	private String order_QA_date;
	private int order_QA_re_level;
	private int order_QA_re_step;
	...
	public String getOrder_QA_subject() {
		return order_QA_subject;
	}
	public void setOrder_QA_subject(String order_QA_subject) {
		this.order_QA_subject = order_QA_subject;
	}
	...
	public int getOrder_QA_re_level() {
		return order_QA_re_level;
	}
	public void setOrder_QA_re_level(int order_QA_re_level) {
		this.order_QA_re_level = order_QA_re_level;
	}
	public int getOrder_QA_re_step() {
		return order_QA_re_step;
	}
	public void setOrder_QA_re_step(int order_QA_re_step) {
		this.order_QA_re_step = order_QA_re_step;
	}
